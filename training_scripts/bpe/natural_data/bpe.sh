...
subword-nmt apply-bpe -c de-en.codes < ../../../data/natural_data/train/de-en.de > bpe_data/de-en.de
subword-nmt apply-bpe -c de-en.codes < ../../../data/natural_data/train/de-en.en > bpe_data/de-en.en
subword-nmt apply-bpe -c gl-en.codes < ../../../data/natural_data/train/gl-en.gl > bpe_data/gl-en.gl
subword-nmt apply-bpe -c gl-en.codes < ../../../data/natural_data/train/gl-en.en > bpe_data/gl-en.en
